...
def get_package_name_from_path(file_path, base_dir):
    ...
    # TODO: fetch prefix from 'module <value>' in go.mod (at root path)
    relative_path = "github.com/nicholaspcr/GoDE/" + os.path.relpath(os.path.dirname(abs_file_path), abs_base_dir)
